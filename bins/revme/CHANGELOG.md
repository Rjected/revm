...
## [0.6.0](https://github.com/Rjected/revm/compare/revme-v0.5.0...revme-v0.6.0) - 2024-06-12

### Added
- *(revme)* add prague spec ([#1506](https://github.com/Rjected/revm/pull/1506))

### Other
- skip tests with storage check and return status ([#1452](https://github.com/Rjected/revm/pull/1452))
