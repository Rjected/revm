...
## [14.2.0](https://github.com/Rjected/revm/compare/revm-inspector-v14.1.0...revm-inspector-v14.2.0) - 2025-12-19
...
- replace HashMap with fixed-size array for opcode counts in CountInspector ([#3203](https://github.com/Rjected/revm/pull/3203))
