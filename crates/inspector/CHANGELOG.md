...
## [6.1.0](https://github.com/Rjected/revm/compare/revm-inspector-v6.0.0...revm-inspector-v6.1.0) - 2025-06-09

### Added

- *(InspectEvm)* add inspect_finalize method for tx+inspector with state ([#2593](https://github.com/Rjected/revm/pull/2593))
