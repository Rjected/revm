...
## [1.0.0](https://github.com/Rjected/revm/releases/tag/revm-specification-v1.0.0) - 2024-11-01

### Added

- restructuring Part6 transaction crate ([#1814](https://github.com/Rjected/revm/pull/1814))
- Merge validation/analyzis with Bytecode ([#1793](https://github.com/Rjected/revm/pull/1793))
...
- fix `constants` module typo ([#1801](https://github.com/Rjected/revm/pull/1801))
- migrate off alloy-eips ([#1789](https://github.com/Rjected/revm/pull/1789))
