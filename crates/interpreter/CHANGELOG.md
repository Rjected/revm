...
## [8.2.0](https://github.com/Rjected/revm/compare/revm-interpreter-v8.1.0...revm-interpreter-v8.2.0) - 2024-07-18

### Added
- *(interpreter)* derive traits on FunctionStack ([#1640](https://github.com/Rjected/revm/pull/1640))

### Other
- use `is_zero` for `U256` and `B256` ([#1638](https://github.com/Rjected/revm/pull/1638))
- fix some typos & remove useless Arc::clone ([#1621](https://github.com/Rjected/revm/pull/1621))
- *(eof)* avoid some allocations ([#1632](https://github.com/Rjected/revm/pull/1632))
