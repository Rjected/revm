...
## [7.0.0](https://github.com/Rjected/revm/compare/revm-context-interface-v6.0.0...revm-context-interface-v7.0.0) - 2025-06-09

### Added

- add optional priority fee check configuration ([#2588](https://github.com/Rjected/revm/pull/2588))
