...
## [4.2.0](https://github.com/Rjected/revm/compare/revm-context-v4.1.0...revm-context-v4.2.0) - 2025-05-21

### Added

- add builder pattern for TxEnv ([#2518](https://github.com/Rjected/revm/pull/2518))
- make Journal::set_code to be EIP-7702 zero address bytecode aware ([#2511](https://github.com/Rjected/revm/pull/2511))
